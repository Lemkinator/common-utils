...
kover {
    reports {
        ...
        variant("debug") {
            verify {
                rule { minBound(10, coverageUnits = kotlinx.kover.gradle.plugin.dsl.CoverageUnit.INSTRUCTION) }
                rule { minBound(5, coverageUnits = kotlinx.kover.gradle.plugin.dsl.CoverageUnit.BRANCH) }
            }
        }
    }
}
