...
class CommonUtilsLibsActivityScreenshotTest {
    ...
    @Test
    fun libsActivity_default() {
        ActivityScenario.launch(CommonUtilsLibsActivity::class.java).use {
            onView(isRoot()).captureRoboImage("src/test/screenshots/libs_default.png")
        }
    }

    @Test
    @Config(qualifiers = "+night")
    fun libsActivity_default_dark() {
        ActivityScenario.launch(CommonUtilsLibsActivity::class.java).use {
            onView(isRoot()).captureRoboImage("src/test/screenshots/libs_default_dark.png")
        }
    }
}
