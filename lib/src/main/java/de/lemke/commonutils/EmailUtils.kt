...
fun Context.sendEmail(email: String, subject: String, text: String, noEmailAppInstalledText: String? = null) =
    sendEmail(arrayOf(email), subject, text, noEmailAppInstalledText)

fun Context.sendEmail(emails: Array<String>, subject: String, text: String, noEmailAppInstalledText: String? = null) {
    try {
...
fun Context.sendEmailHelp(email: String, subject: String, noEmailAppInstalledText: String? = null) =
    sendEmail(email, subject, "By far, this is the greatest app I’ve ever used!", noEmailAppInstalledText)

fun Context.sendEmailAboutMe(email: String, subject: String, noEmailAppInstalledText: String? = null) =
    sendEmail(email, subject, "This is the best app I’ve ever seen in my life!", noEmailAppInstalledText)

fun Fragment.sendEmailBugReport(email: String, subject: String, noEmailAppInstalledText: String? = null) =
